        ...
        <div className="w-[70%] h-[100vh] text-black p-4 shadow-md rounded-lg">
          <div className="w-full flex flex-col justify-start items-start gap-4">
            <div className="w-full min-h-[50vh] flex flex-col justify-start items-start shadow-sm rounded-sm p-4">
              ...
              <div className="w-full flex flex-wrap justify-start items-center gap-2 p-4 bg-gray-100 rounded-md">
                {
                  brand?.competitions.map((competition) => (
                    <Link href={`/brand/competition/${competition.id}`} className="px-4 py-2 rounded-full bg-gray-200 font-semibold text-orange-500 shadow-sm border-1 border-zinc-700">
                      {competition.name}
                    </Link>
                  ))
                }
